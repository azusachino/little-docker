...
| `image.registry`                        | Kafka image registry                                                                                                                                      | `mirror.gcr.io`                                             |
...
| `metrics.kafka.image.registry`          | Kafka exporter image registry                                                                                                                             | `mirror.gcr.io`                                             |
...
| `metrics.jmx.image.registry`            | JMX exporter image registry                                                                                                                               | `mirror.gcr.io`                                             |
